...
model = torch.load("./preTrainedCNNSVHN")
classifier = torch.load("./preTrainedClassiferSVHN")

train_dataset = MNIST(csv_file="./hw3_data/digits/usps/train.csv", root_dir="./hw3_data/digits/usps/train",transform=transforms.Compose([
